...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '057f7efdbf237bb4acaeef71eb65c6416c095b3ac4d1347de5aee6964eeca887'),
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'username' => env('DS_USERNAME', 'my_app'),
            'password' => env('DS_PASSWORD', 'secret'),
            'database' => env('DS_DATABASE', 'my_app'),
            /*
